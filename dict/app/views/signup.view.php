            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Аккаунт ашу</h5>
                    <p class="text-center small">Аккаунт ашу үшін өз деректеріңізді енгізіңіз!</p>
                  </div>

                  <form method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-6">
                      <label for="yourName" class="form-label">Есіміңіз</label>
                      ...
                      <div class="invalid-feedback">Есіміңізді енгізіңіз!</div>
                    ...
                    <div class="col-6">
                      <label for="yourName2" class="form-label">Тегіңіз</label>
                      ...
                      <div class="invalid-feedback">Тегіңізді енгізіңіз!</div>
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Email-ыңыз</label>
                      ...
                      <div class="invalid-feedback">Жарамды email адресін енгізіңіз!</div>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Құпиясөз</label>
                      ...
                      <div class="invalid-feedback">Құпиясөзді енгізіңіз!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Құпиясөзді қайта енгізу</label>
                      <input value="<?= set_value('retype_password')?>" type="password" name="retype_password" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Құпиясөзді қайта енгізіңіз!</div>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <div class="invalid-feedback">Тіркелмес бұрын шарттарға келісуіңіз керек!</div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Аккаунт ашу!</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Аккаунтыңыз бар ма?<a href="<?=ROOT?>/login">Кіру</a></p>
                    </div>
                  </form>
