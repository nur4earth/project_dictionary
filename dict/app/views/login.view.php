            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Аккаунтқа кіру</h5>
                    <p class="text-center small">Логин мен құпиясөзді енгізіңіз</p>
                  </div>
                  ...
                  <form method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Email-ді енгізіңіз!.</div>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Есте сақтау</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Кіру</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Аккаунт жоқ па? <a href="<?=ROOT?>/signup"> Аккаунт ашу</a></p>
                    </div>
                  </form>
